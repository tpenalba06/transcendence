...
function Tourney() {
    ...
    const [name1, set_name1] = useState("Player1")
    ...
    function handleLocalPong() {
      navigate(`/tourney/tourneyPresentation/`, {state : { isAI : isAI, map : map_index, design : design_index, points : p, players : players, name1 : name1,
        name2 : name2, name3 : name3, name4 : name4, name5 : name5, name6 : name6, name7 : name7, name8 : name8}});
    }
    ...
    return (
        <>
            ...
            <div className='container'>
              <div></div>
            <div className='grid'>
                <Player name={name1} set_name={set_name1} image={icone_1} position={0} points={players} />
                <Player name={name2} set_name={set_name2} image={icone_2} position={0} points={players} />
                <Player name={name3} set_name={set_name3} image={icone_3} position={1} points={players} />
                <Player name={name4} set_name={set_name4} image={icone_4} position={2} points={players} />
                <Player name={name5} set_name={set_name5} image={icone_5} position={3} points={players} />
                <Player name={name6} set_name={set_name6} image={icone_6} position={4} points={players} />
                <Player name={name7} set_name={set_name7} image={icone_7} position={5} points={players} />
                <Player name={name8} set_name={set_name8} image={icone_8} position={6} points={players} />
            </div>
              <div></div>
            </div>
            <div className='container'>
